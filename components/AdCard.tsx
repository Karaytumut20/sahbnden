            ...
            <div>
              <div className="flex justify-between items-start">
                ...
                <button
                  ...
                  className="p-1.5 rounded-full hover:bg-yellow-50 transition-colors group/star"
                >
                  <Star size={20} className={liked ? "fill-yellow-400 text-yellow-400" : "text-gray-400 group-hover/star:text-yellow-400"} />
                </button>
              </div>
