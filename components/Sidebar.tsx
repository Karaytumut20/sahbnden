        ...
        {categories.map((cat) => {
          ...
          return (
            <li key={cat.id} className="group border-b border-gray-100 last:border-0 relative dark:border-gray-700">
              <Link href={`/search?category=${cat.id}`} className="flex items-center justify-between px-3 py-2.5 text-[13px] text-[#333] hover:bg-blue-50 hover:text-blue-700 transition-colors dark:text-gray-200 dark:hover:bg-blue-900/30 dark:hover:text-blue-400">
